<?php printHeader('admin', false, 'administration ~ news', false); ?>
            <div id="admin-news" class="block-middle">
                ...
                <div style="text-align:center;">
                    <a href="news.php?admin=add">[ Ajouter une news ]</a>
                </div><br />
                ...
                <?php foreach($newsArray as $news){ ?>
                    <tr>
                        ...
                        <td><a href="news.php?admin=edit&amp;id=<?php echo $news["ID"]; ?>" class="a-img"><img src="pencil.png" alt="[ ✏ éditer ]" /></a></td>
                        <td><a href="news.php?admin=del&amp;id=<?php echo $news["ID"]; ?>" class="a-img"><img src="cross.png" alt="[ ✖ supprimer ]" /></a></td>
                    </tr>
            <?php    } ?>
                </table>
            </div>
